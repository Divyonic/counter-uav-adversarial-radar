...
from fmcw_simulation import (generate_dataset, generate_drone_signal, 
                               generate_bird_signal, generate_friendly_uav_signal,
                               generate_aircraft_signal, apply_cfar,
...
def train_cnn_lstm_model(X_train_seq, bfp_train_seq, y_train_seq,
    ...
    y_v = torch.LongTensor(y_val_seq).to(DEVICE)
...
def measure_latency(model, is_sequence=False):
    ...
    use_bfp = hasattr(model, 'classifier') and not is_sequence
